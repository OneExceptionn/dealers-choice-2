...
const syncAndSeed = async() => {
    ...
    const [ Ashe, Garen, Ryze, Soraka, Warwick ] = await Promise.all([
        Champions.create ({name: 'Ashe', region: 'Freiljord', lane: 'Bottom', damageType: 'Physical', image:'https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Ashe_0.jpg'}),
